...
back = PhotoImage(file="G:/Music Player/images/back.png")
image_1 = Label(window,bg='#7852E6',image=back)
image_1.place(x=41,y=41)

image_image_1 = PhotoImage(file="G:/Music Player/images/image_2.png")
image_2 = Label(window,bg='#7852E6',image=image_image_1)
image_2.place(x=60,y=340)

drake_img = PhotoImage(file="G:/Music Player/images/drake.png")
image_3 = Label(window,bg='#7852E6',image=drake_img)
image_3.place(x=203, y=131)

play_button = PhotoImage(file="G:/Music Player/images/play.png")
...
next_button = PhotoImage(file="G:/Music Player/images/next.png")
...
pre_button = PhotoImage(file="G:/Music Player/images/previous.png")
...
playlist_button = PhotoImage(file="G:/Music Player/images/playlist.png")
...
button_image_6 = PhotoImage(file="G:/Music Player/images/play.png")
...
os.chdir(r'G:/Music Player/songs')
songs = os.listdir()

button_image_1 = PhotoImage(file="G:/Music Player/images/pause.png")
...
resume_pic = PhotoImage(file="G:/Music Player/images/play.png")
